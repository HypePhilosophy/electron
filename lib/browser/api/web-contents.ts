...
WebContents.prototype._init = function () {
  ...
  this.on('pepper-context-menu' as any, function (event: Electron.Event, params: {x: number, y: number, menu: Array<(MenuItemConstructorOptions) | (MenuItem)>}, callback: () => void) {
  ...
  if (this.getType() !== 'remote') {
    ...
    this.on('-new-window' as any, (event: Electron.Event, url: string, frameName: string, disposition: string,
    ...
    this.on('-will-add-new-contents' as any, (event: Electron.Event, url: string, frameName: string, rawFeatures: string) => {
